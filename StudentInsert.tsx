...
export default class StudentInsert extends Component<{}, State> {
  ...
  handleOtherButtonPress = () => {
    // Assuming you have a component named 'OtherScreen' for the other screen
    this.props.navigation.navigate('Screen'); // Navigate to 'OtherScreen'
  };
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity style={[styles.button, { marginTop: 10 }]} onPress={this.handleOtherButtonPress}>
...
const styles = StyleSheet.create({
  ...
  buttonContainer: {
    ...
    justifyContent: 'flex-start', // Align buttons to start of the container
  },
});
